...
이번 프로젝트에서는 페이지 단위가 아닌 컴포넌트 단위로 개발을 하였습니다.
...
기능 구현에서는
곡 업로드하기 기능, 비밀번호 찾기 기능, 특정 곡 정보 가져오기 기능, 좋아요 높은 순(차트)으로 곡 가져오기 기능, 곡 정보 수정하기 기능, 플레이리스트 댓글 조회, 추가, 수정, 삭제 기능, 유저 팔로우하기, 언팔로우하기 기능을 구현하였습니다.
